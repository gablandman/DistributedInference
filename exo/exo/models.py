...
model_cards = {
    "llama-3.1-tulu-3-8b-4b": {
        "layers": 32,
        "repo": {
            "MLXDynamicShardInferenceEngine": "mlx-community/LLama-3.1-Tulu-3-8B-4b",
        },
    },
    ### llama
    "llama-3.2-1b": {
...
pretty_name = {
    "llama-3.1-tulu-3-8b-4b": "Tulu-3-8B < LLama 3.1",
...
def get_supported_models(
    supported_inference_engine_lists: List[List[str]],
) -> List[str]:
