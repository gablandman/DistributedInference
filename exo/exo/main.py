...
if args.discovery_module == "udp":
    # Assuming UDPDiscovery is modified for unicast
    args.known_peers = {
        "Malo": ("77.136.67.102", 5678),
        # "Gary": ("84.14.112.188", 5678),
    }
    discovery = UDPDiscovery(
        node_id=args.node_id,
        node_port=args.node_port,
        listen_port=args.listen_port,
        known_peers=args.known_peers.values(),  # Pass the list of known peers, initially empty
